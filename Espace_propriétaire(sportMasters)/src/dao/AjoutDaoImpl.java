...
public class AjoutDaoImpl implements AjoutDao {
    ...
    public void ajouter(Terrain terrain) throws DAOException {
        ...
        try {
			...
			if (statut == 0) {
				throw new DAOException("Échec de la création du terrain, aucune ligne ajoutée dans la table.");
			}
			...
			if (valeursAutoGenerees.next()) {
				...
				throw new DAOException("Échec de la création du terrain en base, aucun ID auto-généré retourné.");
			}
